class AuditEntityModel {
  ...
  late final List<AuditAdditionalFieldTypeValues> auditAdditionalFieldTypeValues;
  late final List<AuditAdditionalFieldEntityTypes> auditAdditionalFieldEntityTypes;
  ...
  AuditEntityModel.fromJson(Map<String, dynamic> json){
    auditDetailsList = List.from(json['auditDetailsList']).map((e)=>AuditDetailsList.fromJson(e)).toList();
    scoringTypes = List.from(json['scoringTypes']).map((e)=>ScoringTypes.fromJson(e)).toList();
    scoringFormulaInfoModel = List.from(json['scoringFormulaInfoModel']).map((e)=>ScoringFormulaInfoModel.fromJson(e)).toList();
    auditScoring = List.from(json['auditScoring']).map((e)=>AuditScoring.fromJson(e)).toList();
    auditEntity = List.from(json['auditEntity']).map((e)=>AuditEntity.fromJson(e)).toList();
    auditQuestion = List.from(json['auditQuestion']).map((e)=>AuditQuestion.fromJson(e)).toList();
    auditEntityTypes = List.from(json['auditEntityTypes']).map((e)=>AuditEntityTypes.fromJson(e)).toList();
    auditEntityTypeQuestions = List.from(json['auditEntityTypeQuestions']).map((e)=>AuditEntityTypeQuestions.fromJson(e)).toList();
    auditCorrectiveActions = List.from(json['auditCorrectiveActions']).map((e)=>AuditCorrectiveActions.fromJson(e)).toList();
    auditFailureReason = List.from(json['auditFailureReason']).map((e)=>AuditFailureReason.fromJson(e)).toList();
    auditAdditionalFields = List.from(json['auditAdditionalFields']).map((e)=>AuditAdditionalFields.fromJson(e)).toList();
    auditAdditionalFieldTypeValues = List.from(json['auditAdditionalFieldTypeValues']).map((e)=>AuditAdditionalFieldTypeValues.fromJson(e)).toList();
    auditAdditionalFieldEntityTypes = List.from(json['auditAdditionalFieldEntityTypes']).map((e)=>AuditAdditionalFieldEntityTypes.fromJson(e)).toList();
    size = List.from(json['size']).map((e)=>Size.fromJson(e)).toList();
    auditTeamTask = List.from(json['auditTeamTask']).map((e)=>AuditTeamTask.fromJson(e)).toList();
    teamDetails = List.from(json['teamDetails']).map((e)=>TeamDetails.fromJson(e)).toList();
    userDetails = List.from(json['userDetails']).map((e)=>UserDetails.fromJson(e)).toList();
    userPermission = List.from(json['userPermission']).map((e)=>UserPermission.fromJson(e)).toList();
    occurrenceScheduleDates = List.from(json['occurrenceScheduleDates']).map((e)=>OccurrenceScheduleDates.fromJson(e)).toList();
    auditEnforceTimeData = List.from(json['auditEnforceTimeData']).map((e)=>AuditEnforceTimeData.fromJson(e)).toList();
    auditGroups = List.from(json['auditGroups']).map((e)=>AuditGroups.fromJson(e)).toList();
    resumeAuditLatestData = List.castFrom<dynamic, dynamic>(json['resumeAuditLatestData']);
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['auditDetailsList'] = auditDetailsList.map((e)=>e.toJson()).toList();
    _data['scoringTypes'] = scoringTypes.map((e)=>e.toJson()).toList();
    _data['scoringFormulaInfoModel'] = scoringFormulaInfoModel.map((e)=>e.toJson()).toList();
    ...
    _data['auditEntityTypes'] = auditEntityTypes.map((e)=>e.toJson()).toList();
    _data['auditEntityTypeQuestions'] = auditEntityTypeQuestions.map((e)=>e.toJson()).toList();
    _data['auditCorrectiveActions'] = auditCorrectiveActions.map((e)=>e.toJson()).toList();
    _data['auditFailureReason'] = auditFailureReason.map((e)=>e.toJson()).toList();
    _data['auditAdditionalFields'] = auditAdditionalFields.map((e)=>e.toJson()).toList();
    _data['auditAdditionalFieldTypeValues'] = auditAdditionalFieldTypeValues.map((e)=>e.toJson()).toList();
    _data['auditAdditionalFieldEntityTypes'] = auditAdditionalFieldEntityTypes.map((e)=>e.toJson()).toList();
    ...
    _data['occurrenceScheduleDates'] = occurrenceScheduleDates.map((e)=>e.toJson()).toList();
    _data['auditEnforceTimeData'] = auditEnforceTimeData.map((e)=>e.toJson()).toList();
...
class AuditEnforceTimeData {
  ...
  late final int auditId;
  late final DateTime fromTime;
  late final DateTime toTime;
